  ...
  return (
    ...
    <div className="container mx-auto py-2">
      ...
      <div className="grid grid-cols-2 gap-4 mt-6">
        {/* Tasks Component */}
        <div className="col-span-2 sm:col-span-1 bg-orange p-5 h-96 overflow-y-auto rounded-lg shadow-md">
      ...
      <div className="grid grid-cols-2 gap-4 mt-6">
        ...
        <div className="col-span-2 sm:col-span-1 bg-orange p-6 rounded-lg shadow-md">
